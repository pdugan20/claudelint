 ...
 *
 * Generated: 2026-01-29T05:07:52.431Z
 * Rules registered: 66
 */
...
// This happens automatically when this module is imported
  RuleRegistry.register(skill_version_rule.meta);
  RuleRegistry.register(skill_too_many_files_rule.meta);
  RuleRegistry.register(skill_time_sensitive_content_rule.meta);
  RuleRegistry.register(skill_tags_rule.meta);
  RuleRegistry.register(skill_path_traversal_rule.meta);
  RuleRegistry.register(skill_naming_inconsistent_rule.meta);
  RuleRegistry.register(skill_name_rule.meta);
  RuleRegistry.register(skill_model_rule.meta);
  RuleRegistry.register(skill_missing_version_rule.meta);
  RuleRegistry.register(skill_missing_shebang_rule.meta);
  RuleRegistry.register(skill_missing_examples_rule.meta);
  RuleRegistry.register(skill_missing_comments_rule.meta);
  RuleRegistry.register(skill_missing_changelog_rule.meta);
  RuleRegistry.register(skill_large_reference_no_toc_rule.meta);
  RuleRegistry.register(skill_eval_usage_rule.meta);
  RuleRegistry.register(skill_disallowed_tools_rule.meta);
  RuleRegistry.register(skill_description_rule.meta);
  RuleRegistry.register(skill_dependencies_rule.meta);
  RuleRegistry.register(skill_deep_nesting_rule.meta);
  RuleRegistry.register(skill_dangerous_command_rule.meta);
  RuleRegistry.register(skill_context_rule.meta);
  RuleRegistry.register(skill_body_too_long_rule.meta);
  RuleRegistry.register(skill_allowed_tools_rule.meta);
  RuleRegistry.register(skill_agent_rule.meta);
  RuleRegistry.register(settings_permission_invalid_rule_rule.meta);
  RuleRegistry.register(settings_permission_empty_pattern_rule.meta);
  RuleRegistry.register(settings_invalid_permission_rule.meta);
  RuleRegistry.register(settings_invalid_env_var_rule.meta);
  RuleRegistry.register(plugin_missing_file_rule.meta);
  RuleRegistry.register(plugin_invalid_version_rule.meta);
  RuleRegistry.register(plugin_invalid_manifest_rule.meta);
  RuleRegistry.register(plugin_dependency_invalid_version_rule.meta);
  RuleRegistry.register(plugin_circular_dependency_rule.meta);
  RuleRegistry.register(commands_in_plugin_deprecated_rule.meta);
  RuleRegistry.register(output_style_name_rule.meta);
  RuleRegistry.register(output_style_examples_rule.meta);
  RuleRegistry.register(output_style_description_rule.meta);
  RuleRegistry.register(mcp_invalid_transport_rule.meta);
  RuleRegistry.register(mcp_invalid_server_rule.meta);
  RuleRegistry.register(mcp_invalid_env_var_rule.meta);
  RuleRegistry.register(hooks_missing_script_rule.meta);
  RuleRegistry.register(hooks_invalid_event_rule.meta);
  RuleRegistry.register(hooks_invalid_config_rule.meta);
  RuleRegistry.register(commands_migrate_to_skills_rule.meta);
  RuleRegistry.register(commands_deprecated_directory_rule.meta);
  RuleRegistry.register(claude_md_size_warning_rule.meta);
  RuleRegistry.register(claude_md_size_error_rule.meta);
  RuleRegistry.register(claude_md_rules_circular_symlink_rule.meta);
  RuleRegistry.register(claude_md_paths_rule.meta);
  RuleRegistry.register(claude_md_import_missing_rule.meta);
  RuleRegistry.register(claude_md_import_in_code_block_rule.meta);
  RuleRegistry.register(claude_md_import_circular_rule.meta);
  RuleRegistry.register(claude_md_glob_pattern_too_broad_rule.meta);
  RuleRegistry.register(claude_md_glob_pattern_backslash_rule.meta);
  RuleRegistry.register(claude_md_filename_case_sensitive_rule.meta);
  RuleRegistry.register(claude_md_content_too_many_sections_rule.meta);
  RuleRegistry.register(agent_tools_rule.meta);
  RuleRegistry.register(agent_skills_rule.meta);
  RuleRegistry.register(agent_skills_not_found_rule.meta);
  RuleRegistry.register(agent_name_rule.meta);
  RuleRegistry.register(agent_model_rule.meta);
  RuleRegistry.register(agent_hooks_rule.meta);
  RuleRegistry.register(agent_hooks_invalid_schema_rule.meta);
  RuleRegistry.register(agent_events_rule.meta);
  RuleRegistry.register(agent_disallowed_tools_rule.meta);
  RuleRegistry.register(agent_description_rule.meta);
