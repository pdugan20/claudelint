...
│   ├── /plugin/                   # Plugin rules (13 rules)
│   ├── /output-styles/            # Output styles rules (7 rules)
│   ├── /agents/                   # Agents rules (13 rules)
...
Each of the 105 rules gets its own page following this structure:
...
/>
<meta property="og:image" content="https://docs.claudelint.dev/og-image.png" />
...
- **Completeness**: All 105 rules documented
...
- **Comprehensive coverage** of all 105 rules and 10 validators
