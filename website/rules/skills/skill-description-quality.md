...
<RuleHeader description="Skill description should start with an action verb and include sufficient context" severity="warn" :fixable="false" :configurable="false" category="Skills" />
